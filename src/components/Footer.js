        ...
        <footer className='my-10 darkblue p-6 shadow-2xl rounded-xl text-white'>
            <div className="flex justify-between flex-col md:flex-row gap-2">
                <p className="sm:text-xl flex items-center gap-2">
                    Creator: <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" fill="currentColor" className="bi bi-github" viewBox="0 0 16 16">
                ...
                <p>Website data is updated to the latest in game version: {process.env.REACT_APP_LATEST_UPDATED}</p>
            </div>
